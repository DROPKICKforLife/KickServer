"""
Django settings for KickServer project.
...
SECRET_KEY = '%9g+j17$*l17aq)yb6b^)umf1mqqs%zcm^-6sh8&=aw%c7k$pq'
...
WSGI_APPLICATION = 'KickServer.wsgi.application'
