...
def predict_tree(url:None):
    ...
    model_directory = [ dir_path+'/tree_models/tree_leaf_model',dir_path+'/tree_models/tree_stem_model' ,dir_path+'/tree_models/tree_roots_model' ]
    ...
    for i in file_add :
        ...
        f.close()
    # post_data = {'result' : transmitting_sentences}
    # url = 'http://ec2-52-78-149-26.ap-northeast-2.compute.amazonaws.com/recv/testurl'
    #
    # r = requests.post(url, data = post_data)
    print(transmitting_sentences)
    return transmitting_sentences
# predict_tree('http://somaserver.s3.ap-northeast-2.amazonaws.com/2_tree1512498645.670976.png')